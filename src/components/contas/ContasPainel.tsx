  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Visão geral das suas contas a pagar e receber</p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-5">
        ...
        <Card>
          ...
          <CardContent>
            <div className={`text-2xl font-bold ${stats.saldoProjetado >= 0 ? 'text-green-600' : 'text-red-600'}`}>
